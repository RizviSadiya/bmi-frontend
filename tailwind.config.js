...
const generatePalette = require(path.resolve(__dirname, ('src/@bmi/tailwind/utils/generate-palette')));
...
const config = {
    ...
    plugins     : [
        ...
        // Bmi - Tailwind plugins
        require(path.resolve(__dirname, ('src/@bmi/tailwind/plugins/extract-config'))),
        require(path.resolve(__dirname, ('src/@bmi/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('src/@bmi/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('src/@bmi/tailwind/plugins/theming')))({themes}),
