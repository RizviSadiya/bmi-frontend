...
@Component({
  selector: 'app-influencer-proposal-list',
  templateUrl: './influencer-proposal-list.component.html',
  styleUrls: ['./influencer-proposal-list.component.scss']
})
export class InfluencerProposalListComponent implements OnInit {
