...
@Component({
  selector: 'app-influencer-proposal',
  templateUrl: './influencer-proposal.component.html',
  styleUrls: ['./influencer-proposal.component.scss']
})
export class InfluencerProposalComponent implements OnInit ,OnDestroy{
