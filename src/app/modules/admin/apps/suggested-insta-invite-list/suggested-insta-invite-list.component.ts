...
@Component({
  selector: 'app-suggested-insta-invite-list',
  templateUrl: './suggested-insta-invite-list.component.html',
  styleUrls: ['./suggested-insta-invite-list.component.scss']
})
export class SuggestedInstaInviteListComponent implements OnInit {
