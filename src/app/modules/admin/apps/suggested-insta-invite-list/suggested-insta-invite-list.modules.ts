...
import { SuggestedInstaInviteListRoutes } from './suggested-insta-invite-list.routing';
...
@NgModule({
    declarations: [
        ...
        SuggestedInstaInviteListComponent,
      
    ],
    imports     : [
        RouterModule.forChild(SuggestedInstaInviteListRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class SuggestedInstaInviteListModule
{
}
