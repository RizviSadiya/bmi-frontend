...
import { SuggestedInviteListRoutes } from './suggested-invite-list.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(SuggestedInviteListRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class SuggestedInviteListModule
{
}
