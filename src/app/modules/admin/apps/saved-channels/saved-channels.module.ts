...
import { savedChannelsRoutes } from 'app/modules/admin/apps/saved-channels/saved-channels.routing';
...
@NgModule({
    declarations: [
        SavedChannelsComponent
    ],
    imports     : [
        RouterModule.forChild(savedChannelsRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class SavedChannelsModule
{
}
