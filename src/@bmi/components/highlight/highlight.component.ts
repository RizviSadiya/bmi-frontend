...
import { BmiHighlightService } from '@bmi/components/highlight/highlight.service';
...
export class BmiHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _fuseHighlightService: BmiHighlightService,
