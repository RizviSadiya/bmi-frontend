...
import { BmiNavigationItem, BmiVerticalNavigationAppearance, BmiVerticalNavigationMode, BmiVerticalNavigationPosition } from '@bmi/components/navigation/navigation.types';
...
export class BmiVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input() appearance: BmiVerticalNavigationAppearance = 'default';
    @Input() autoCollapse: boolean = true;
    @Input() inner: boolean = false;
    @Input() mode: BmiVerticalNavigationMode = 'side';
    @Input() name: string = this._fuseUtilsService.randomId();
    @Input() navigation: BmiNavigationItem[];
    @Input() opened: boolean = true;
    @Input() position: BmiVerticalNavigationPosition = 'left';
    @Input() menuItems: any;
    @Input() userCredit: any;
    @Input() transparentOverlay: boolean = false;
    @Output() readonly appearanceChanged: EventEmitter<BmiVerticalNavigationAppearance> = new EventEmitter<BmiVerticalNavigationAppearance>();
    @Output() readonly modeChanged: EventEmitter<BmiVerticalNavigationMode> = new EventEmitter<BmiVerticalNavigationMode>();
    @Output() readonly openedChanged: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() readonly positionChanged: EventEmitter<BmiVerticalNavigationPosition> = new EventEmitter<BmiVerticalNavigationPosition>();
    @ViewChild('navigationContent') private _navigationContentEl: ElementRef;

    activeAsideItemId: string | null = null;
    onCollapsableItemCollapsed: ReplaySubject<BmiNavigationItem> = new ReplaySubject<BmiNavigationItem>(1);
    onCollapsableItemExpanded: ReplaySubject<BmiNavigationItem> = new ReplaySubject<BmiNavigationItem>(1);
    ...
    private _fuseScrollbarDirectives!: QueryList<BmiScrollbarDirective>;
     ...
     */
    @ViewChildren(BmiScrollbarDirective)
    set fuseScrollbarDirectives(fuseScrollbarDirectives: QueryList<BmiScrollbarDirective>)
    {
     ...
     * @param item
     */
    openAside(item: BmiNavigationItem): void
    {
     ...
     * @param item
     */
    toggleAside(item: BmiNavigationItem): void
    {
        // Toggle
